document.addEventListener('DOMContentLoaded', function() {
  var NAV = '<header class="site-header">'
    ...
    + '  </div>'
    + '  <a href="/index.html" class="header-logo">Luciano Iacobelli</a>'
    ...
    + '<a href="/art/large.html">Large Artwork</a>'
    + '<a href="/art/medium.html">Medium Art</a>'
    + '<a href="/art/small.html">Small Art</a>'
    + '<a href="/art/digital.html">Digital Art</a>'
    + '<a href="/art/assemblage.html">Assemblage</a>'
    + '</div></div>'
    + '<a href="/poetry-books/index.html" class="nav-link">Poetry Books</a>'
    + '<a href="/lyricalmyrical/index.html" class="nav-link">LyricalMyrical Covers</a>'
    + '<a href="/lucs-apartment/index.html" class="nav-link">Luc\'s Apartment</a>'
